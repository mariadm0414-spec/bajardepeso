...
import LandingDiabeticos from './LandingDiabeticos';
...
export default function LandingPage() {
    ...
    const isDiabetes = searchParams.get('goal') === 'diabetes';

    const cta = () => {
        if (isDiabetes) {
            window.location.href = 'https://pay.hotmart.com/B104822312F?off=5xe96upq';
        } else {
            // Nota: Se asume que el link proporcionado aplica a la landing actual o a todos los flujos comerciales
            window.location.href = 'https://pay.hotmart.com/B104822312F?off=5xe96upq';
        }
    };

    if (isDiabetes) return <LandingDiabeticos />;
            ...
            <section style={{ background: 'linear-gradient(160deg, #064e3b 0%, #065f46 50%, #047857 100%)', minHeight: '88vh', display: 'flex', alignItems: 'center', padding: '5rem 1.5rem', position: 'relative', overflow: 'hidden' }}>
                ...
                <div style={{ maxWidth: 780, margin: '0 auto', textAlign: 'center', position: 'relative', zIndex: 1 }}>
                    ...
                    <h1 style={{ fontFamily: 'Playfair Display, serif', fontSize: 'clamp(2.4rem, 6vw, 4rem)', color: '#fff', lineHeight: 1.15, marginBottom: '1.25rem', fontWeight: 900 }}>
                        Baja de peso sin<br />
                        <span style={{ color: '#6ee7b7' }}>pasar hambre ni ir al gimnasio</span> en<br />
